...
//        $this->email();
    ...
    public function email(){
        ...
        $sendmail = '397836421@qq.com'; //发件人邮箱
        $sendmailpswd = "11234"; //客户端授权密码,而不是邮箱的登录密码，就是手机发送短信之后弹出来的一长串的密码
        $send_name = 'lh';// 设置发件人信息，如邮件格式说明中的发件人，
        $toemail = '1140977015@qq.com';//定义收件人的邮箱
        ...
        $mail->Subject = "这里是邮件标题11111";// 邮件标题
